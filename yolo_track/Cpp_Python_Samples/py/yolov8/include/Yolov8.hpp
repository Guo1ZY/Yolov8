...
struct YoloDetect
{
    int id = -1;                             // id（只有在使用Track模式的时候才有意义）
...
private:
    /*为Python添加的import路径*/
    std::string pySysPath = "/home/zy/桌面/yolo_track/Cpp_Python_Samples/py/yolov8/py";
    /*置信度阈值*/
    ...
    // YoloMode yolomode = YoloMode::Onnx;
    YoloMode yolomode = YoloMode::Track;
