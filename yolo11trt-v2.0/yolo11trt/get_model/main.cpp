/*
 * @Author: hejia
 * @Date: 2024-11-02 22:11:34
 * @LastEditors: hejia
 * @LastEditTime: 2024-11-03 10:07:33
 * @Description: 
 * @FilePath: /get_model/main.cpp
 */
...
std::string wts_name = "/home/nyakori/withy/yolo11trt/get_model/best.wts";
std::string engine_name = "/home/nyakori/withy/yolo11trt/get_model/best.trt";//模型后缀可以瞎写
std::string type = "n";
//--------------------------------------------------------------
